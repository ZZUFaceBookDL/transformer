...
class Transformer(nn.Module):
    ...
    ----------
    d_input:
        Model input dimension.[BATCH_SIZE, d_model]
    d_model:
    ...
    def __init__(self,
        ...
        # self._embedding = nn.Conv1d(d_input,d_model,kernel_size=1,stride=1)
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        ----------
        x:
            :class:`torch.Tensor` of shape (batch_size, d_input).
